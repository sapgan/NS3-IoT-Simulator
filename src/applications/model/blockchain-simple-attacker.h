#ifndef BLOCKCHAIN_SIMPLE_ATTACKER_H
#define BLOCKCHAIN_SIMPLE_ATTACKER_H
 ...
 */
class BlockchainSimpleAttacker : public BlockchainNode
{
public:
  /**
  ...
  BlockchainSimpleAttacker ();

  virtual ~BlockchainSimpleAttacker (void);
...
#endif /* BLOCKCHAIN_SIMPLE_ATTACKER_H */
