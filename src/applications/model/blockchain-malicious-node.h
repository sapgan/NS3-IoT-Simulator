#ifndef BLOCKCHAIN_MALICIOUS_NODE_H
#define BLOCKCHAIN_MALICIOUS_NODE_H
...
class BlockchainMaliciousNode : public BlockchainValidator
{
public:
  /**
  ...
  BlockchainMaliciousNode ();

  virtual ~BlockchainMaliciousNode (void);
...
#endif /* BLOCKCHAIN_MALICIOUS_NODE_H */
