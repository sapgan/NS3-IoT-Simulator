...
/*                     PrintQueueChunks();
            ...
            case CHUNK:
            {
              ...
              Simulator::Schedule (Seconds(eventTime), &BlockchainNode::ReceivedChunkMessage, this, help, from);
              Simulator::Schedule (Seconds(receiveTime), &BlockchainNode::RemoveReceiveTime, this);
...
void
BlockchainNode::ReceivedChunkMessage(std::string &chunkInfo, Address &from)
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::ReceivedLastChunk(const Block &newBlock)
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::SendChunk(std::string packetInfo, Address& from)
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::AdvertiseFirstChunk (const Block &newBlock)
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::PrintChunkTimeouts()
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::PrintQueueChunks()
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::PrintReceivedChunks()
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::PrintQueueChunkPeers()
{
  NS_LOG_FUNCTION (this);
...
void
BlockchainNode::ChunkTimeoutExpired(std::string chunk)
{
  NS_LOG_FUNCTION (this);
...
bool
BlockchainNode::HasChunk (std::string blockHash, int chunk)
{
  NS_LOG_FUNCTION (this);
