...
PyNs3TrafficControlLayer__PythonHelper::GetRootQueueDiscOnDevice(ns3::Ptr< ns3::NetDevice > device)
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::TrafficControlLayer *self_obj_before;
...
_wrap_PyNs3TrafficControlLayer_RegisterProtocolHandler(PyNs3TrafficControlLayer *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyObject *handler;
    ns3::Ptr<PythonCallbackImpl0> handler_cb_impl;
    int protocolType;
    PyNs3NetDevice *device;
    ns3::NetDevice *device_ptr;
    ...
    handler_cb_impl = ns3::Create<PythonCallbackImpl0> (handler);
