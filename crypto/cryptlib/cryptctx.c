...
int createContextFromCapability( OUT_HANDLE_OPT CRYPT_CONTEXT *iCryptContext,
	...
	*iCryptContext = CRYPT_ERROR;
	...
	/* If this is a dummy object remember that it's just a placeholder with 
	   actions handled externally.  We have to reflect the flag down into the
	   PKC info as well for situations where only the PKC_INFO data is 
	   available.  In addition, if it's a persistent object (backed by a 
