...
const char *getSSHPacketName( IN_RANGE( 0, 255 ) const int packetType )
	...
	static const PACKET_NAME_INFO packetNameInfo[] = {
		...
		{ SSH_MSG_KEX_INIT, "SSH_MSG_KEX_INIT/SSH_MSG_KEX_DH_GEX_REQUEST_OLD/SSH_MSG_KEX_ECDH_INIT" },
		{ SSH_MSG_KEX_REPLY, "SSH_MSG_KEX_REPLY/SSH_MSG_KEX_DH_GEX_GROUP/SSH_MSG_KEX_ECDH_REPLY" },
...
static int checkPacketValid( IN_BYTE const int packetType, 
	...
	static const int validHSPacketTbl[] = {
		...
		SSH_MSG_NEWKEYS, SSH_MSG_KEX_INIT, SSH_MSG_KEX_REPLY,
